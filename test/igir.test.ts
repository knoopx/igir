...
describe('with explicit DATs', () => {
  ...
  it('should copy and test', async () => {
    await copyFixturesToTemp(async (inputTemp, outputTemp) => {
      ...
      expect(result.outputFilesAndCrcs).toEqual([
        ...
        [`${path.join('One', 'CD-ROM.chd')}|CD-ROM (Track 1).bin|2352@0`, '49ca35fb'],
        [`${path.join('One', 'CD-ROM.chd')}|CD-ROM (Track 2).bin|4704@2352`, '0316f720'],
        [`${path.join('One', 'CD-ROM.chd')}|CD-ROM (Track 3).bin|7056@7056`, 'a320af40'],
  ...
  it('should copy a 1G1R set', async () => {
    await copyFixturesToTemp(async (inputTemp, outputTemp) => {
      ...
      expect(result.outputFilesAndCrcs).toEqual([
        ['CD-ROM.chd|CD-ROM (Track 1).bin|2352@0', '49ca35fb'],
        ['CD-ROM.chd|CD-ROM (Track 2).bin|4704@2352', '0316f720'],
        ['CD-ROM.chd|CD-ROM (Track 3).bin|7056@7056', 'a320af40'],
  ...
  it('should copy and clean read-only files', async () => {
    await copyFixturesToTemp(async (inputTemp, outputTemp) => {
      ...
      expect(result.outputFilesAndCrcs).toEqual([
        ...
        [`${path.join('chd', 'One', 'CD-ROM.chd')}|CD-ROM (Track 1).bin|2352@0`, '49ca35fb'],
        [`${path.join('chd', 'One', 'CD-ROM.chd')}|CD-ROM (Track 2).bin|4704@2352`, '0316f720'],
        [`${path.join('chd', 'One', 'CD-ROM.chd')}|CD-ROM (Track 3).bin|7056@7056`, 'a320af40'],
  ...
  it('should symlink and test', async () => {
    await copyFixturesToTemp(async (inputTemp, outputTemp) => {
      ...
      expect(result.outputFilesAndCrcs).toEqual([
        ...
        [`${path.join('One', 'CD-ROM.chd')}|CD-ROM (Track 1).bin|2352@0 -> ${path.join('<input>', 'chd', 'CD-ROM.chd')}|CD-ROM (Track 1).bin|2352@0`, '49ca35fb'],
        [`${path.join('One', 'CD-ROM.chd')}|CD-ROM (Track 2).bin|4704@2352 -> ${path.join('<input>', 'chd', 'CD-ROM.chd')}|CD-ROM (Track 2).bin|4704@2352`, '0316f720'],
        [`${path.join('One', 'CD-ROM.chd')}|CD-ROM (Track 3).bin|7056@7056 -> ${path.join('<input>', 'chd', 'CD-ROM.chd')}|CD-ROM (Track 3).bin|7056@7056`, 'a320af40'],
  ...
  it('should copy and test', async () => {
    await copyFixturesToTemp(async (inputTemp, outputTemp) => {
      ...
      expect(result.outputFilesAndCrcs).toEqual([
        ...
        ['three.rom', 'ff46c5d8'],
        ['track01.bin', '9796ed9a'],
        ['track02.raw', 'abc178d5'],
        ['track03.bin', '61a363f1'],
        ['track04.bin', 'fc5ff5a0'],
        ['two.rom', '96170874'],
  ...
  it('should copy, zip, and test', async () => {
    await copyFixturesToTemp(async (inputTemp, outputTemp) => {
      ...
      expect(result.outputFilesAndCrcs).toEqual([
        ...
        ['CD-ROM (Track 1).zip|CD-ROM (Track 1).bin', '49ca35fb'],
        ['CD-ROM (Track 2).zip|CD-ROM (Track 2).bin', '0316f720'],
        ['CD-ROM (Track 3).zip|CD-ROM (Track 3).bin', 'a320af40'],
        ...
        ['track01.zip|track01.bin', '9796ed9a'],
        ['track02.zip|track02.raw', 'abc178d5'],
        ['track03.zip|track03.bin', '61a363f1'],
        ['track04.zip|track04.bin', 'fc5ff5a0'],
  ...
  it('should relative symlink, and test', async () => {
    await copyFixturesToTemp(async (inputTemp, outputTemp) => {
      ...
      expect(result.outputFilesAndCrcs).toEqual([
        ...
        [`CD-ROM.chd|CD-ROM (Track 1).bin|2352@0 -> ${path.join('..', 'input', 'roms', 'chd', 'CD-ROM.chd|CD-ROM (Track 1).bin|2352@0')}`, '49ca35fb'],
        [`CD-ROM.chd|CD-ROM (Track 2).bin|4704@2352 -> ${path.join('..', 'input', 'roms', 'chd', 'CD-ROM.chd|CD-ROM (Track 2).bin|4704@2352')}`, '0316f720'],
        [`CD-ROM.chd|CD-ROM (Track 3).bin|7056@7056 -> ${path.join('..', 'input', 'roms', 'chd', 'CD-ROM.chd|CD-ROM (Track 3).bin|7056@7056')}`, 'a320af40'],
        ...
        [`track01.bin -> ${path.join('..', 'input', 'roms', 'discs', 'track01.bin')}`, '9796ed9a'],
        [`track02.raw -> ${path.join('..', 'input', 'roms', 'discs', 'track02.raw')}`, 'abc178d5'],
        [`track03.bin -> ${path.join('..', 'input', 'roms', 'discs', 'track03.bin')}`, '61a363f1'],
        [`track04.bin -> ${path.join('..', 'input', 'roms', 'discs', 'track04.bin')}`, 'fc5ff5a0'],
